        ...
        if (delegateToUse == null) {
            synchronized(this.delegateMonitor) {
                ...
                if (delegateToUse == null) {
                    ...
                    // 2.拼接SpringMVC将容器存入ServletContext域的时候使用的属性名
                    String serevletName = "springDispatcherServlet";

                    String attrName = FrameworkServlet.SERVLET_CONTEXT_PREFIX + serevletName;

                    // 3.根据serevletName从ServletContext域中获取IOC容器对象
