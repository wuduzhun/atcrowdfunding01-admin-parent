...
public class CrowdConstant {
    ...
    public static final String MESSAGE_ACCESS_FORBIDEN = "请登陆以后在访问！";
    ...
    public static final String MESSAGE_CODE_NOT_EXISTS = "验证已过期！请检查收件是否正确或重新发送！";
    ...
    public static final String MESSAGE_HEADER_PIC_UPLOAD_EMPTY = "头图不可为空！";
    ...
    public static final String MESSAGE_TEMPLE_PROJECT_MISSING = "临时存储的对象丢失！";
