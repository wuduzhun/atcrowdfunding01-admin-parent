...
<script type="text/javascript">
    ...
    function initPagination() {
        // 获取总记录数
        var totalRecored = ${requestScope.pageInfo.total};
        ...
        var properties = {
            ...
            items_per_page:${requestScope.pageInfo.pageSize }, //每页要显示数据得数量
            current_page: ${requestScope.pageInfo.pageNum - 1 }, //Pagination内部使用pageIndex来管理页码，pageIndex从0开始，pageNumcom从1开始，所以要减一
            prex_text: "上一页",
            next_text: "下一页"
        };

        // 生成页码导航条
        $("#Pagination").pagination(totalRecored,properties);

        // 回调函数的含义：声明出来以后不是自己调用，而是交给系统或框架用
        // 用户点击“123”这样的页码时调用这个函数实现页面跳转
        // pageIndex是Pagination传给我们那个从“0”开始的页码
        function pageSelectCallBack(pageIndex,jQuery){
            ...
            // 由于每个页码按钮都是超链接，所以在这个函数最后取消超连接默认行为
            return false;
        }
    }
